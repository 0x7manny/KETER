...
export default function LandingPage({ onConnect, onExplore, isConnecting }: LandingPageProps) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-keter-bg">
          ...
          <ScrollReveal delay={150}>
            <div className="group">
              ...
              <p className="text-sm text-keter-text-secondary leading-relaxed">
                ...
                It proves Merkle tree membership, EU jurisdiction compliance, and transfer limits
                — without revealing identity, country, or KYC status.
              </p>
            </div>
          </ScrollReveal>
            ...
            <div className="bg-white border border-keter-border-light rounded-2xl p-8">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  { label: 'Proof system', value: 'None', bad: true },
            ...
            <div className="bg-white border-2 border-keter-accent/30 rounded-2xl p-8 shadow-lg shadow-keter-accent/5">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  { label: 'Proof system', value: 'Noir V2 + UltraPlonk' },
      ...
      {/* Documentation CTA */}
      <ScrollReveal className="relative z-10 max-w-6xl mx-auto px-6 pb-24">
        <div className="bg-white border border-keter-border-light rounded-2xl p-8 sm:p-10 text-center">
          <p className="text-xs font-medium text-keter-text-muted uppercase tracking-widest mb-3">
            Learn more
          </p>
          <h3 className="font-serif text-2xl text-keter-text mb-6">
            Dive into the technical blueprint
          </h3>
          <div className="flex flex-wrap items-center justify-center gap-3">
            {[
              { label: 'Architecture', href: '/docs/architecture' },
              { label: 'ZK Circuit', href: '/docs/circuit' },
              { label: 'Smart Contracts', href: '/docs/contracts' },
              { label: 'Protocol Flow', href: '/docs/flow' },
            ].map((doc) => (
              <Link
                key={doc.href}
                href={doc.href}
                className="px-5 py-2.5 bg-keter-bg border border-keter-border-light rounded-xl text-sm text-keter-text font-medium hover:border-keter-accent hover:text-keter-accent transition-colors"
              >
                {doc.label}
              </Link>
            ))}
